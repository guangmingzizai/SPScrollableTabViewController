...
@interface SPTabViewController : UIViewController <SPPageViewControllerDataSource, SPPageViewControllerDelegate, SPTabDataSource, SPTabDelegate>
...
@property (nonatomic, readonly) SPPageViewController *pageController;
