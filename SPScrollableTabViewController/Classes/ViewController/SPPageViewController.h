...
#define KSTATUSBARHEIGHT ([SPPageViewController iPhoneX]?44.0:20.0)
...
@property (nonatomic, weak) id <SPPageViewControllerDelegate> delegate;
@property (nonatomic, weak) id <SPPageViewControllerDataSource> dataSource;
